...
export const mapMovimientoSimple = (mov: Movimiento) => {
  return {
    ...
    idHK: mov?.usuarioH?.id ?? null,
    idC: mov?.usuarioC?.id ?? null,
    idS: mov?.usuarioS?.id ?? null,
    nomHK: mov?.usuarioH?.nombres ?? null,
    nomC: mov?.usuarioC?.nombres ?? null,
    nomS: mov?.usuarioS?.nombres ?? null,
    statusHK: mov?.statusLimpH?.codigo ?? null,
    statusC: mov?.statusLimpC?.codigo ?? null,
    statusS: mov?.statusLimpS?.codigo ?? null,
